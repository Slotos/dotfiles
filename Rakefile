...
def install_homebrew
  ...
  puts "======================================================"
  run %{brew install zsh git hub tmux reattach-to-user-namespace ripgrep ghi hub proselint}
  run %{brew tap universal-ctags/universal-ctags}
  run %{brew install --HEAD universal-ctags}
